...
from sokolova.utils import get_client_ip
from sokolova.email import send_contact_email_message
from django.shortcuts import render
...
def index1(request):
    ...
    newsapi = NewsApiClient(api_key ='bfd745de62d842ef98f5aecc238f4643')
